...
public class MockEmployees {
    ...
    public static final Map<UUID, Employee> MOCK_STORE = new ConcurrentHashMap<>();

    static {
        add("Ada", "Lovelace", "ada@example.com", "Staff Engineer", 250000, 36, Instant.parse("2020-01-01T00:00:00Z"));
        add(
                "Grace",
                "Hopper",
                "grace@example.com",
    ...
    private static void add(
            String first, String last, String email, String jobTitle, int salary, int age, Instant date) {
